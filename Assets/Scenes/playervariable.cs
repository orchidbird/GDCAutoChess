...
public class playervariable : MonoBehaviour
{
    ...
    public void HeroStat()
    {
        ...
        heroMap2.Add(nameOfHero[0], new Synergy(nameOfHero[0], heroType[0], heroClass[0], heroHealth[0], heroPower[0]));
        heroMap2.Add(nameOfHero[1], new Synergy(nameOfHero[1], heroType[0], heroClass[2], heroHealth[1], heroPower[1]));
        heroMap2.Add(nameOfHero[2], new Synergy(nameOfHero[2], heroType[0], heroClass[3], heroHealth[2], heroPower[2]));
        heroMap2.Add(nameOfHero[3], new Synergy(nameOfHero[3], heroType[0], heroClass[4], heroHealth[3], heroPower[3]));
        heroMap2.Add(nameOfHero[4], new Synergy(nameOfHero[4], heroType[1], heroClass[1], heroHealth[4], heroPower[4]));
        heroMap2.Add(nameOfHero[5], new Synergy(nameOfHero[5], heroType[1], heroClass[2], heroHealth[5], heroPower[5]));
        heroMap2.Add(nameOfHero[6], new Synergy(nameOfHero[6], heroType[1], heroClass[3], heroHealth[6], heroPower[6]));
        heroMap2.Add(nameOfHero[7], new Synergy(nameOfHero[7], heroType[2], heroClass[0], heroHealth[7], heroPower[7]));
        heroMap2.Add(nameOfHero[8], new Synergy(nameOfHero[8], heroType[2], heroClass[1], heroHealth[8], heroPower[8]));
        heroMap2.Add(nameOfHero[9], new Synergy(nameOfHero[9], heroType[3], heroClass[0], heroHealth[9], heroPower[9]));
        heroMap2.Add(nameOfHero[10], new Synergy(nameOfHero[10], heroType[3], heroClass[1], heroHealth[10], heroPower[10]));
        heroMap2.Add(nameOfHero[11], new Synergy(nameOfHero[11], heroType[4], heroClass[1], heroHealth[11], heroPower[11]));
        heroMap2.Add(nameOfHero[12], new Synergy(nameOfHero[12], heroType[4], heroClass[4], heroHealth[12], heroPower[12]));
        heroMap2.Add(nameOfHero[13], new Synergy(nameOfHero[13], heroType[5], heroClass[0], heroHealth[13], heroPower[13]));
        heroMap2.Add(nameOfHero[14], new Synergy(nameOfHero[14], heroType[5], heroClass[1], heroHealth[14], heroPower[14]));
        heroMap2.Add(nameOfHero[15], new Synergy(nameOfHero[15], heroType[5], heroClass[4], heroHealth[15], heroPower[15]));
